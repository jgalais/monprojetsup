...
class RecupererFormationServiceTest {
    ...
    inner class ProfilNonNull {
        ...
        fun `doit retourner les domaines et interets`() {
            ...
            val interets =
                listOf(
                    InteretSousCategorie(id = "T_ROME_731379930", nom = "je veux aider les autres"),
                    InteretSousCategorie(id = "T_ROME_1959553899", nom = "je veux créer quelque chose de mes mains"),
                )
